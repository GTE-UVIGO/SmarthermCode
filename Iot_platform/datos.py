...
#Cart positions
positions = pd.read_csv(r"E:\Documents\Doctorado\Proyecto CINTECX\positions_new.csv", sep=";", decimal=",")
...
dayofyear = X_final.iloc[:, 36]
#dayofyear_F = x_test.iloc[:, 32]
X_final = X_final.drop(X_final.columns[37], axis=1)
...
#################################################################################################
dates=pd.date_range(start='18/11/2020 00:00', periods=162057, freq='min')
X_final.index=dates
X_final.to_csv(r'E:\Documents\Doctorado\Proyecto CINTECX\Mendeley\CINTECX_data.csv', index=True, sep=';', decimal='.')
